...
#include "miryoku_layer_alternatives.h"
    ...
    #if defined (MIRYOKU_ALPHAS_BEAKL15)
    ...
    #elif defined (MIRYOKU_ALPHAS_FWYR5)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_FWYR_FLIP
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_ALPHAS_FWYR5)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_FWYR5
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
  ...
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_EXTRA_BEAKL15)
    ...
    #elif defined (MIRYOKU_EXTRA_FWYR5)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_FWYR5_FLIP
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_EXTRA_FWYR5)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_FWYR5
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
  ...
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_TAP_BEAKL15)
    ...
    #elif defined (MIRYOKU_TAP_FWYR5)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_FWYR5_FLIP
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_TAP_FWYR5)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_FWYR5
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH
    #endif
  #endif
